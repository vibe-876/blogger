...
/* package blogger-0.1.0.0 */
#ifndef VERSION_blogger
#define VERSION_blogger "0.1.0.0"
#endif /* VERSION_blogger */
#ifndef MIN_VERSION_blogger
#define MIN_VERSION_blogger(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_blogger */
...
#define CURRENT_COMPONENT_ID "blogger-0.1.0.0-inplace-blogger"
